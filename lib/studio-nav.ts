...
export const STUDIO_NAV: NavItem[] = [
  ...
  { href: "/app/ai-studio", fr: "AI Studio", en: "AI Studio", icon: "studio", locked: true, section: "main" },
  { href: "/app/influencers", fr: "Influenceurs", en: "Influencers", icon: "influencers", locked: true, section: "main" },
