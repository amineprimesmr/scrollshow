...
const examples = [
  ...
  { name: "Camille", role: ["Créatrice indépendante", "Independent creator"], color: "#f1dfe4", text: ["Je peux ajuster les textes et le ton avant de publier. Je choisis le contenu et les options de chaque publication.", "I can adjust the copy and tone before publishing. I choose the content and settings for every post."] },
...
export function LandingFooter({ english }: { english: boolean }) {
  return <footer className="sl-footer">
    <div className="sl-footer__main">
      <div className="sl-footer__brand"><Link href="/" aria-label="ScrollShow"><img src="/logo.png" width="36" height="36" alt="" /><strong>ScrollShow</strong></Link><p>{t("Crée. Prévisualise. Publie.", "Create. Preview. Publish.", english)}</p><a className="sl-footer__contact" href="mailto:aminennasri@outlook.com">aminennasri@outlook.com</a></div>
